...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		finger_tip_y = int((landmarks[8].y)*width)

		thumb_tip_x = int((landmarks[4].x)*width)
		thumb_tip_y = int((landmarks[4].y)*width)
		...
		print("Mouse Position:",mouse.position,"Tips Lines Center Position:",center_x,center_y)	
